...
- `20260824154415_b01_auth_rate_limit_audit.sql`: approved-policy-only subject/global Auth rate-limit buckets and append-only HMAC-fingerprint audit capability; no numeric production policy is seeded.
