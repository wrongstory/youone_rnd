...
import { BackendContractNotice, EmptyOperationalState, OperationalPageHeader, OperationalStateBadge } from "../../../interface/operational-ui";
...
export default function FormalResearchApplicationListPage() {
  const applications = previewDataEnabled() ? previewApplications : [];
  return (
