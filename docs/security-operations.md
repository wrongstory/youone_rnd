...
| `OD-035` numeric recovery/backup values are approved but actual monitoring/evidence stable IDs, incident/recovery actor UUIDs and drill proof are unbound | Versioned policy snapshot with exact bindings plus RPO 60m/RTO 240m isolated recovery evidence |
