...
| `OD-037-P1-DEVELOPMENT-GATE` | Confirm P1 module depth, cross-feature offline/notification/form scope, merge order and implementation start | `PARTIALLY_DECIDED` | `P1_DEVELOPMENT_GATE` | User approved recommended `P1-SCOPE-V1.0` and `DELIVERY-PLAN-P1-V0.1`, 2026-08-23; P0 release and P1 design review remain | Preserve the approved scope/order, but do not create P1 package/table/route/menu/migration until the remaining prerequisites and explicit implementation Gate are complete. |
